                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="direccion"
                                                    id="direccion" placeholder="escribir descripcion" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="telefono"
                                                    id="telefono" placeholder="escribir descripcion" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="email"
                                                    id="email" placeholder="escribir descripcion" required>
                                            </div>
                                        </div>
